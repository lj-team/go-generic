...
func TestParse(t *testing.T) {
	...
	_, err = Parse("2014-13-13 08:20:13,787") // month 13 doesn't exist so error
	assert.NotEqual(t, nil, err)
	...
	_, err = Parse("138421636711122233311111") // too many digits
	assert.NotEqual(t, nil, err)
