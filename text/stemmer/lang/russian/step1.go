...
func step1(word *snowballword.Word) bool {
...
//
func removePerfectiveGerundEnding(word *snowballword.Word) bool {
...
//
func removeAdjectivalEnding(word *snowballword.Word) bool {
...
//
func removeVerbEnding(word *snowballword.Word) bool {
	suffix, suffixRunes := word.FirstSuffixIn(word.RVstart, len(word.RS),
...
//
func precededByARinRV(word *snowballword.Word, suffixLen int) bool {
