...
import (
	"github.com/lj-team/go-generic/text/stemmer/lang/romance"
...
//
func normalizeApostrophes(word *snowballword.Word) (numSubstitutions int) {
...
//
func trimLeftApostrophes(word *snowballword.Word) {
	var (
		numApostrophes int
		r              rune
	)
...
//
func capitalizeYs(word *snowballword.Word) (numCapitalizations int) {
	for i, r := range word.RS {
...
//
func uncapitalizeYs(word *snowballword.Word) {
	for i, r := range word.RS {
...
//
func r1r2(word *snowballword.Word) (r1start, r2start int) {
...
//
func isShortWord(w *snowballword.Word) (isShort bool) {
...
//
func endsShortSyllable(w *snowballword.Word, i int) bool {
